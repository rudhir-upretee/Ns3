 ...
 */
#ifndef VANET_MONITOR_HELPER_H
#define VANET_MONITOR_HELPER_H
...
namespace ns3
    ...
    class VanetMonitorHelper
         ...
         *        to.
         */
        VanetMonitorHelper(std::string protocol, Address address);
